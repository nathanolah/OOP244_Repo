...
namespace sdds
{
   ...
   const char DATE_ERROR[5][20] = { // [16]
      //"No Error",
      //"Invalid Date Object", // cin Failed
      //"Bad Year Value",
      //"Bad Month Value",
      //"Bad Day Value"
      "Invalid Date Object",
   ...
   // Helper functions
   std::istream& operator>>(std::istream& leftOperand, Date& rightoperand);
   std::ostream& operator<<(std::ostream& leftOperand, const Date& rightOperand);
